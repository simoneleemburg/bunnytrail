...
A Knight in transit is Nearing space the way a Nearer of time
nears the past — softening their attachment to it enough that
it stops behaving as a fixed constraint. Raw distance does not
go away. The pilot does not teleport. The space between worlds
remains vast. But the pilot's relation to that vastness loosens
sufficiently that crossing it becomes possible in a span of
...
cross. The work is sustained Nearing, held across the whole
length of the journey, without either failing or running away.
...
holds: they can breathe, think, perceive, remain a person.
When the pilot's Nearing fails, the bubble fails. The pilot's
coherence is the bubble's coherence.

## Aspect Wings

Around the Eidolon, during travel, the Naya extends what are
called _Aspect Wings_ or _Resonance Veils_ — semi-visible
structures of resonance shaped by the Naya's nature. The Wings
are not literal wings. They are not made of matter in the
ordinary sense. They function as propulsion, shielding,
orientation, and — at the limits of the practice — as the
visible signature of who the Naya _is_ when distance is no
longer holding it in place.

No two Wings are alike, because no two Naya are. Some Wings
read as refracted, glass-like, bending light into patterns the
pilot can almost recognise. Some crackle with storm and arc,
ripping through the medium they pass through. Others are
softer, less seen than felt — pressure rather than figure.

The Wings appear only in transit. They do not unfurl on a
planet's surface, and they do not unfurl during launch. They
are something the Eidolon does only while space is being
neared.

## Movement

Interplanetary motion is not thrust-based. Eidolons do not
push themselves forward. They move by pulling themselves
toward alignment points — the resonant analogues of
gravitational lines, emotional currents, and what older
traditions call the celestial scars left by the shattering.

In practice this means the pilot is not aiming. The pilot is
_falling_, in a controlled direction, along currents that are
already present in the space between worlds. The work is to
choose which currents to align with, to remain coupled with
them long enough to be carried, and to disengage cleanly when
a new alignment is needed.

This is consistent with Nearing's broader logic. Nearing is
never accomplished by force. A Nearer who pushes loses contact
with what they are Nearing; a pilot who pushes loses contact
with the currents. Both lose contact in the same way, for the
same reason. The successful pilot follows.

## Navigation

Because movement is alignment rather than thrust, navigation
is interpretive rather than mathematical. A pilot reads:
...
- the negotiated sense, between Knight and Naya, of which
...
- **Missing the catch.** The pilot arrives near their
  ...
  [[concepts/the-void|the Void Between Worlds]].

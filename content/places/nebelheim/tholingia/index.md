Tholingia [[tho]] is a region of [[places/nebelheim|Nebelheim]] — one
named territory among many on a world whose geography refuses
to be a single country. The land is Nebelheimic in temperament:
...
have shaped both what it is and how it is known.
...
with several has both the means to send and the means to
receive, and Tholingia has both at greater concentration than
anywhere else on Nebelheim.

What follows from that, materially:

- **Trade.** Goods that arrive on Nebelheim from
  [[places/bayurinda|Bayurinda]] or [[places/sharazan|Sharazan]]
  pass, more often than not, through Tholingian catch-structures.
  Goods leaving Nebelheim begin their journey on Tholingian
  rails. The region's wealth, such as it is, is built on the
  position rather than on what the soil itself produces.
- **Contact.** Off-world Knights, scholars, and emissaries who
  come to Nebelheim arrive in Tholingia first. The region has
  the longest institutional memory on the planet of how to

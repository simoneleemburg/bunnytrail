...
with the silt and the deep, and the working day of a Bayurindan
life — whichever Bayurindan life — is shaped by this more than
by anything that the sky alone could decide.

This was not always the proportion of land to sea. In an age
that is now considered mythic — long enough ago that ordinary
memory does not reach it, ancient enough that what remains is
held in songs, in liturgies, and in the patient archival work
of the [[bayurinda#peoples-of-bayurinda|deep]] — Bayurinda
had a great deal more surface than it has now. A civilisation
lived on that surface. Most of it is underwater.

The peculiarity, by ordinary mythic standards, is that the
myth is verifiable. The cities are still there. The deep walk
through them.

## The drowning

[[the-drowning|The drowning]] — the submergence of the surface
civilisation — is the central fact of Bayurindan history. The
archipelago that survives above the water claims, by long
tradition, to be the part of the old country that the seas
spared; this is disputed (see _Peoples_, below). Most of what
the rest of [Alteria Cognita](/cognita) knows about Bayurinda —
its scholarly tradition, the
[[culture/languages/old-tongue|Old Tongue]], the contemplative
ethic, the patience that strikes outsiders as a kind of
philosophical discipline — flows from it.
...
To speak of "Bayurindan culture" in the scholarship of the other
Sister Worlds is to speak of a tradition with three layers:

- the **lost** layer — the work, language, and discipline of the
  drowned civilisation, accessible now only through what the deep
  have preserved and what the archipelago has been taught;
- the **deep** layer — the long custodianship, in which the lost
  work has been kept, copied, refined, and in places extended,
  across the centuries since the drowning;
- the **surface** layer — the present archipelago life, which
...
That tone has obvious roots in the drowning: a civilisation that
has lost its world once, and is in the slow business of recovering
what can be recovered, does not value haste.
...
through them from the work of a civilisation that no longer
breathes air. A Knighthood lived on Bayurinda therefore stands
between several centres of gravity at once: the working life of
the archipelago, the patient custodianship of the deep, and the
older silence beneath both.
...
[[collection:aurethia/places/regions/bayurinda]]

...
_Nebelheim_ — is Tholingian for the same reason.
...
Tholingian names are marked, where they appear, with the small
superscript _tho_ — the same dictionary-style attribution used
for other languages.
...
antiquarians. One is recorded here because it appears
occasionally in older scholarship and would otherwise puzzle
the reader:

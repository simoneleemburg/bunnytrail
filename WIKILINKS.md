...
The full contract for `[[…]]` syntax in Alteria prose.
...
All broken links **render visibly** and **show up in the engine
...
- **Check the health page** at the engine's site `/health` after authoring — broken,

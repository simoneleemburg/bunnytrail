...
<article class="cognita">
	...
	<section class="map-section">
		...
		<p class="map-intro">
			...
			thing that exists has a place. Three axes — Resonance, Recollection, Dissolution — run through
			the interior, each pointing toward the horizon it measures distance from.
		</p>
		<MundusMap />
	</section>

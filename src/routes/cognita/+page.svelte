...
<svelte:head>
	<title>Alteria Cognita · Alteria</title>
</svelte:head>

<article class="cognita">
	<header>
		<p class="eyebrow">The mapped territory</p>
		<h1>Alteria Cognita</h1>
		<p class="lede">
			If <strong>Alteria</strong> is the whole sprawl of imagination — every world I might one day
			wander into — then <strong>Alteria Cognita</strong> is the part of it I have actually charted. The
			known portion. The pieces that have a name, a shape, a place to stand.
		</p>
		<p class="lede">
			<a href="/places/celestial-bodies/stars/aureth">Aureth</a>, eight planets, and two parallel layers of being. Three of the planets — the
		...
		<p class="lede">
			...
			body it orbits — <a href="/places/celestial-bodies/black-holes/the-dark-companion">the Dark Companion</a>, which gives off
			no light and is known only by what it does.
		</p>
	</header>
	...
	<section class="legend">
		...
		<dl>
			...
			<dt>The threads</dt>
			<dd>
				Faint vertical lines between the twin bodies. Existence is rarely just one or the other; the
			...
			<dd>
				...
				<a href="/places/celestial-bodies/black-holes/the-dark-companion">the Dark Companion</a>, shown as a hollow rather than
				drawn solidly, because no light has ever come from it.
			</dd>
		</dl>
	</section>
</article>

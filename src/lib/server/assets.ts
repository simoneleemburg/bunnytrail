...
class AssetCache {
	...
	async #buildInlineSvgBundle(): Promise<string> {
		...
		const parts: string[] = [
			...
			'   <name>.svg in the world assets dir is wrapped here in',
			'   .bt-inline-svg--<name> { ... } so its rules only apply',
			"   inside the matching figure. Don't edit this URL's body",
			'   directly — edit the per-map CSS files. */',
			''
		];
